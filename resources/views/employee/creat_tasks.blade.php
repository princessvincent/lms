                ...
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <div class="btn-wrapper text-center">
                            <h4 class="btn btn-neutral btn-icon">Create Task</h4>
                        </div>
                        </div>
                        <form role="form" method="POST" action="{{ route('createtask') }}">
                            @csrf
                            ...
                            <div class="form-group{{ $errors->has('points') ? ' has-danger' : '' }}">
                                ...
                                <div class="input-group input-group-alternative mb-3">
                                    <input class="form-control{{ $errors->has('points') ? ' is-invalid' : '' }}"
                                        type="text" placeholder="{{ __('Task Point') }}" name="points"
                                        value="{{ old('points') }}">
                                </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary my-4">{{ __('Create Task') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
